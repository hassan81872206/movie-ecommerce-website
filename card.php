...
<body>
    ...
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    <th><input type="checkbox" id="selectAll" onclick="toggleSelectAll()"> Movie Title</th>
            ...
            <tbody id="movieList">
                ...
                foreach($orders as $order){
                    ?>
                    <tr>
                        <td><input type="checkbox" class="movieCheckbox"><?php echo $order["Title"]; ?></td>
    ...
    <script>
        ...
        function deleteRow(button,count) {
            ...
            let price = document.querySelector(`td[meta-price='${count}']`);
            let qty = document.querySelector(`p[meta-qty='${count}']`);
            console.log(amount.textContent)
            console.log(price.textContent)
            console.log(qty.textContent)
            let newAmount = parseFloat(amount.textContent) - (parseFloat(price.textContent) * parseInt(qty.textContent));
            amount.textContent = newAmount.toFixed(2);
            console.log(amount.textContent)
